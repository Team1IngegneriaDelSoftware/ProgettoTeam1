...
public partial class ClientConnection : global::Improbable.Entity.Component.IComponentFactory
{
  ...
  #pragma warning restore 0618
  {
    ...
    public Impl(global::Improbable.Worker.Connection connection, global::Improbable.EntityId entityId, Data initialData)
    {
      ...
      timeoutBeatsRemainingUpdateEventHandler =
    ...
    private global::Improbable.Entity.Component.PropertyCallbackHandler<uint> timeoutBeatsRemainingUpdateEventHandler;

    public global::Improbable.Entity.Component.PropertyCallbackHandler<uint> TimeoutBeatsRemainingUpdated
    {
      get { return timeoutBeatsRemainingUpdateEventHandler; }
	  set { timeoutBeatsRemainingUpdateEventHandler = value; }
    }
    ...
    private void TriggerCallbacks(Update update)
    {
      ...
      {
        timeoutBeatsRemainingUpdateEventHandler.InvokeCallbacks(update.timeoutBeatsRemaining.Value);
      }
    }
    ...
    private readonly global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<uint>> timeoutBeatsRemainingWrapper =
        new global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<uint>>(TimeoutBeatsRemainingUpdated_Wrap);
    ...
    #pragma warning restore 0618
    {
      add { ComponentUpdated.Add(timeoutBeatsRemainingWrapper.Add(value, value.Target)); value(Data.timeoutBeatsRemaining); }
      remove { ComponentUpdated.Remove(timeoutBeatsRemainingWrapper.Remove(value, value.Target)); }
    }
    ...
    {
      timeoutBeatsRemainingWrapper.DisconnectTarget(actionTarget);
    }
