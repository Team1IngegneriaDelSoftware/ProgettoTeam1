...
namespace Improbable.Core
{
    public class SpatialOsRotationComponent: SpatialOsComponentBase
    {
        ...
        protected global::Improbable.Core.Quaternion rotationValue;
        /// <summary>
        ///     Returns the value of the field 'Rotation'.
        /// </summary>
        public global::Improbable.Core.Quaternion Rotation { get { return rotationValue; } }
        ...
        {
            if (Authority != global::Improbable.Worker.Authority.Authoritative)
            {
        ...
        /// </summary>
        public delegate void OnRotationUpdateCallback(global::Improbable.Core.Quaternion newRotation);
