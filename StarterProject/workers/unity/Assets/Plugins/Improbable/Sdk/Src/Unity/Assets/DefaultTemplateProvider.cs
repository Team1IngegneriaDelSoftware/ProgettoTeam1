            ...
            else
            {
                switch (LoadingStrategy)
                {
                    ...
                    case AssetDatabaseStrategy.Streaming:
                        ...
                        CloudAssemblyArtifactResolver.ResolveAssetUrls(this, new WWWRequest(), SpatialOS.Configuration.InfraServiceUrl, projectName, assemblyName, OnAssetBundleNameToUrlMapResolved, OnAssetResolveFailed);
                        break;
                    default:
